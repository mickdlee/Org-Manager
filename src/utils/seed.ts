...
export function generateSeedData(): AppData {
  // ── People ──────────────────────────────────────────────────────────────────
  const people = [
    { id: 'p01', name: 'Sarah Mitchell',   email: 'sarah.mitchell@example.com' },
    { id: 'p02', name: 'James Okafor',     email: 'james.okafor@example.com' },
    { id: 'p03', name: 'Priya Nair',       email: 'priya.nair@example.com' },
    { id: 'p04', name: 'Tom Bergström',    email: 'tom.bergstrom@example.com' },
    { id: 'p05', name: 'Amelia Rossi',     email: 'amelia.rossi@example.com' },
    { id: 'p06', name: 'Chen Wei',         email: 'chen.wei@example.com' },
    { id: 'p07', name: 'Marcus Johansson', email: 'marcus.johansson@example.com' },
    { id: 'p08', name: 'Fatima Al-Hassan', email: 'fatima.alhassan@example.com' },
    { id: 'p09', name: 'Liam Fitzgerald',  email: 'liam.fitzgerald@example.com' },
    { id: 'p10', name: 'Yuki Tanaka',      email: 'yuki.tanaka@example.com' },
    { id: 'p11', name: 'Natasha Ivanova',  email: 'natasha.ivanova@example.com' },
    { id: 'p12', name: 'Daniel Ferreira',  email: 'daniel.ferreira@example.com' },
    { id: 'p13', name: 'Esi Mensah',       email: 'esi.mensah@example.com' },
    { id: 'p14', name: 'Oliver Nguyen',    email: 'oliver.nguyen@example.com' },
    { id: 'p15', name: 'Ingrid Larsson',   email: 'ingrid.larsson@example.com' },
    { id: 'p16', name: 'Rohan Kapoor',     email: 'rohan.kapoor@example.com' },
    { id: 'p17', name: 'Chloe Dupont',     email: 'chloe.dupont@example.com' },
    { id: 'p18', name: 'Kofi Acheampong',  email: 'kofi.acheampong@example.com' },
  ];
